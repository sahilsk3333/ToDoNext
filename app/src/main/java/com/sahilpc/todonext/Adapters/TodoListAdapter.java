package com.sahilpc.todonext.Adapters;
...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.MyViewHolder> {
    ...
    public TodoListAdapter(ArrayList<TodoModel> arrayList,Context context,  RecyclerViewClickListener clickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        myViewHolder.arrow.setOnClickListener(v -> {
            if(myViewHolder.accordian_body.getVisibility() == View.VISIBLE) {
                myViewHolder.accordian_body.setVisibility(View.GONE);
            } else {
                myViewHolder.accordian_body.setVisibility(View.VISIBLE);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            editBtn.setOnClickListener(v -> clickListener.onEditButtonClick(getAdapterPosition()));

            deleteBtn.setOnClickListener(v -> clickListener.onDeleteButtonClick(getAdapterPosition()));

            doneBtn.setOnClickListener(v -> clickListener.onDoneButtonClick(getAdapterPosition()));
